...
published:
created: 2025-11-17
description: "Deploy and host Claude Agent SDK in production environments"
tags:
  - "clippings"
---
...
- [Sessions Guide](https://docs.claude.com/en/docs/agent-sdk/sessions) - Learn about session management
- [Permissions](https://docs.claude.com/en/docs/agent-sdk/permissions) - Configure tool permissions
- [Cost Tracking](https://docs.claude.com/en/docs/agent-sdk/cost-tracking) - Monitor API usage
- [MCP Integration](https://docs.claude.com/en/docs/agent-sdk/mcp) - Extend with custom tools

[Session Management](https://docs.claude.com/en/docs/agent-sdk/sessions) [Modifying system prompts](https://docs.claude.com/en/docs/agent-sdk/modifying-system-prompts)