...
published:
created: 2025-11-17
description: "Understanding how the Claude Agent SDK handles sessions and session resumption"
tags:
  - "clippings"
---
## Session Management
...
[Handling Permissions](https://docs.claude.com/en/docs/agent-sdk/permissions) [Hosting the Agent SDK](https://docs.claude.com/en/docs/agent-sdk/hosting)